...
public class GetterSetterPair {
  ...
  public void set(Object obj, Object value, int depth) throws ReflectiveOperationException {
    ...
    invokeSetter(setMethod, obj, value);
  }

  /** Java doesn't reveal much details about which constellation of data caused
   * a problem on reflective method calls. So we enrich a potential exception by
   * method, object and argument in the exception text to help the developer
   * understand the cause. */
  private void invokeSetter(Method setMethod, Object obj, Object value) throws ReflectiveOperationException {
    try {
      setMethod.invoke(obj, value);
    }
    catch(IllegalArgumentException iax) {
      String detailedDescription = iax.getMessage() + " - " + setMethod + " - " + obj + " - " + value;
      throw new IllegalArgumentException(detailedDescription);
    }
  }
