...
public class RecordDescriptor
{
  ...
  public RecordDescriptor(RecordDescriptor red, String alias, String altTable) {
    this(red, null, alias, altTable);
  }

  /**
   * Copy constructor
   * @param red The descriptor which to copy data from
   * @param objectType Alternative entity type. May be null to
   *    use the same entity as registered in the passed base descriptor
   ...
   */
  public RecordDescriptor(RecordDescriptor red, Class<?> objectType, String alias, String altTable) {
    if (objectType != null) {
      this.objectType = objectType;
      this.objectFactory = new ObjectFactory(objectType);
    }
    else {
      this.objectType = red.objectType;
      this.objectFactory = red.objectFactory;
    }
    this.dbContext = red.dbContext;
    this.dbtable = (altTable == null) ? red.dbtable : altTable;
    this.dbtableAlias = alias;
