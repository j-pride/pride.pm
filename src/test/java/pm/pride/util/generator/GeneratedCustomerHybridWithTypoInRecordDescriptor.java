 ...
 * @author benutzer1
 */
public class GeneratedCustomerHybridWithTypoInRecordDescriptor extends MappedObject implements Cloneable, java.io.Serializable {
    ...
    protected static final RecordDescriptor red =
            new RecordDescriptor(GeneratedCustomerHybridWithTypoInRecordDescriptor.class, TABLE, null)
    ...
    // Re-constructor
    public GeneratedCustomerHybridWithTypoInRecordDescriptor(long id) throws SQLException {
        setId(id);
        findXE();
    }

    public GeneratedCustomerHybridWithTypoInRecordDescriptor() {}
